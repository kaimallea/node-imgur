# 🚨 v2 development is in progress within the [`next-dev`](https://github.com/kaimallea/node-imgur/tree/next-dev) branch. [See v2 README](https://github.com/kaimallea/node-imgur/blob/next-dev/README.md).
